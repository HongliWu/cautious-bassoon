...
import pytorch_retinanet.model_res2net_vlb
...
MODELS = {
    ...
    ##############res2net##############################
    "res2net101_v1b_26w_4s_dr0.75_512": ModelInfo(
        factory=pytorch_retinanet.model_res2net_vlb.res2net101_v1b_26w_4s,
        args=dict(num_classes=1, pretrained=True, dropout=0.75),
        img_size=512,
        batch_size=6,
        dataset_args=dict(augmentation_level=20),
    ),
    "res2net101_v1b_26w_4s_dr0.75_512_aug21": ModelInfo(
        factory=pytorch_retinanet.model_res2net_vlb.res2net101_v1b_26w_4s,
        args=dict(num_classes=1, pretrained=True, dropout=0.75),
        img_size=512,
        batch_size=6,
